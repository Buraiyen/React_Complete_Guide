...
- let's create data outside of our ~ExpenseItem~ component
  + [[https://github.com/academind/react-complete-guide-code/blob/03-react-basics-working-with-components/extra-files/expenses.txt][insert this data inside of your ~App.js~ component]]
